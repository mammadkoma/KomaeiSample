...
public partial class OrdersOffice
{
    [Parameter] public OrderOfficeDto[]? OrderOfficeDtos { get; set; }
    [Parameter] public bool HasAdminColumns { get; set; } = false;

    private async Task GetGridData()
    {
        OrderOfficeDtos = (await http.GetFromJsonAsync<OrderDto>("Order/GetAll"))!.OrderOfficeDtos;
    }
